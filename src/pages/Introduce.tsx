    ...
    >
      ...
      <section className="mb-12 md:mb-24">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-y-12 md:gap-y-32">
          ...
          <div className="md:col-span-5 self-start pt-1 md:pt-2 -mt-8 md:mt-0">
            <p className="text-lg md:text-xl font-medium text-neutral-400 leading-tight text-right md:text-left">
              깨지지 않는 디테일<br />
              무엇이든 담는 단단함
            </p>
          </div>
          <div className="md:col-span-7 self-start flex justify-start md:justify-end">
            <p className="text-lg md:text-2xl font-medium leading-tight text-left md:text-right">
      ...
      <section className="grid grid-cols-1 md:grid-cols-2 gap-16 border-t border-neutral-200 pt-16">
        ...
        <div>
          <h4 className="text-2xl font-bold mb-4 md:mb-8">OFFICE & DESIGN</h4>
          <div className="flex flex-wrap gap-2">
