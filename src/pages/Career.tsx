...
function AccordionItem({ title, children, isOpen, onClick }: AccordionItemProps) {
  return (
    <div className="border-b border-neutral-200 py-6 last:border-0">
      ...
      >
        <h4 className={`text-xl md:text-2xl font-bold transition-colors duration-300 ${isOpen ? 'text-black' : 'text-neutral-400 group-hover:text-black'}`}>
          {title}
        </h4>
  ...
  return (
    ...
    >
      <header className="mb-24">
        <h1 className="serif text-6xl md:text-8xl font-bold mb-4">CAREER</h1>
        <p className="text-neutral-500 text-lg">Experience & Professional Journey</p>
      </header>
      ...
      <section className="mb-32">
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 border-b-2 border-black pb-4">
          <div>
            ...
            <p className="text-xl text-neutral-600">브랜드 마케팅 총괄 운영</p>
          </div>
          <p className="serif text-2xl font-medium mt-4 md:mt-0">2022.03 - 2025.11</p>
        </div>

        <div className="space-y-24">
          {/* Owned Media */}
          <div>
            <h3 className="serif text-2xl font-bold mb-8 flex items-center">
              <span className="mr-4">▶</span> OWNED MEDIA & CONTENTS
            </h3>
            <div className="flex flex-col">
              <AccordionItem
                title="1. SNS 운영 / 콘텐츠 기획 제작"
                isOpen={!!openItems['sns']}
                onClick={() => toggleItem('sns')}
              >
                <div className="space-y-12">
                  <p className="text-xl text-neutral-600 leading-relaxed max-w-3xl">
                    브랜드/시즌 컨셉을 반영한 콘텐츠를 기획하여 SNS 채널을 운영하였습니다.
                    인스타그램 채널 특성에 적합한 러프한 스타일로 촬영하였습니다.
                  </p>
                  <div className="flex flex-col space-y-12">
                    <div className="bg-neutral-50 p-8 md:p-12">
                      <p className="font-bold text-xl mb-6">진행업무</p>
                      <ul className="list-disc list-inside text-lg text-neutral-600 space-y-3">
                        <li>SNS 채널 운영 관리</li>
                    ...
                    <div className="bg-neutral-50 p-8 md:p-12">
                      <p className="font-bold text-xl mb-6">콘텐츠 예시</p>
                      <ul className="list-disc list-inside text-lg text-neutral-600 space-y-3 mb-8">
              ...
              >
                <div className="space-y-12">
                  <p className="text-xl text-neutral-600 leading-relaxed max-w-3xl">
                    고객 편의성과 세일즈 목적의 자사몰 리뉴얼 작업을 기획하였습니다.
                  ...
                  <div className="flex flex-col space-y-12">
                    ...
                    <div className="bg-neutral-50 p-8 md:p-12">
                      <p className="font-bold text-xl mb-6">결과</p>
                      <ul className="list-disc list-inside text-lg text-neutral-600 space-y-3">
          ...
          <div>
            <h3 className="serif text-2xl font-bold mb-8 flex items-center">
              <span className="mr-4">▶</span> PERFORMANCE MARKETING
            </h3>
            <div className="flex flex-col">
              <AccordionItem
                title="1. META (MUSINSA)"
                isOpen={!!openItems['meta']}
                onClick={() => toggleItem('meta')}
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                  <div className="bg-neutral-900 text-white p-12 rounded-sm">
                    <p className="serif text-5xl md:text-6xl font-bold mb-2">ROAS 800%</p>
                    <p className="text-lg opacity-70">최고 달성 1,123%</p>
                  </div>
                  <ul className="list-disc list-inside text-xl text-neutral-600 space-y-4">
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
                  <div className="bg-yellow-400 text-black p-12 rounded-sm">
                    <p className="serif text-5xl md:text-6xl font-bold mb-2">CTR +8%</p>
                    <p className="text-lg opacity-70">쿠폰 클릭/발급율 7-10% 상승</p>
                  </div>
                  <ul className="list-disc list-inside text-xl text-neutral-600 space-y-4">
          ...
          <div>
            <h3 className="serif text-2xl font-bold mb-8 flex items-center">
              <span className="mr-4">▶</span> CELEB COLLABO & SEEDING
            </h3>
            <div className="flex flex-col">
              <AccordionItem
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="md:col-span-1">
                    <div className="p-8 border-l-4 border-black bg-neutral-50">
                      <p className="text-4xl font-bold">매출 9억</p>
                      <p className="text-sm text-neutral-500 mt-2">발매 후 7일 기준</p>
                    </div>
                  </div>
                  <div className="md:col-span-2 text-xl text-neutral-600 space-y-6">
              ...
              >
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                  <div className="md:col-span-1">
                    <div className="p-8 border-l-4 border-black bg-neutral-50">
                      <p className="text-4xl font-bold">매출 12억</p>
                      <p className="text-sm text-neutral-500 mt-2">발매 후 7일 기준</p>
                    </div>
                  </div>
                  <div className="md:col-span-2 text-xl text-neutral-600 space-y-6">
      ...
      <section>
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-12 border-b-2 border-black pb-4">
          <div>
            ...
            <p className="text-xl text-neutral-600">채널 운영/기획 및 콘텐츠 제작</p>
          </div>
          <p className="serif text-2xl font-medium mt-4 md:mt-0">2020.01 - 2021.01</p>
        </div>
        ...
        <div className="flex flex-col">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="bg-green-50 p-12 rounded-sm">
                <p className="font-bold text-3xl text-green-800">팔로워 230% 성장</p>
                <p className="text-lg text-green-700 mt-2">1,500 → 5,000명</p>
              </div>
              <ul className="text-xl text-neutral-600 space-y-4">
          ...
          >
            <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
              <div className="bg-red-50 p-12 rounded-sm">
                <p className="font-bold text-3xl text-red-800">조회수 160% 상승</p>
                <p className="text-lg text-red-700 mt-2">시즌2 평균 1,300회</p>
              </div>
